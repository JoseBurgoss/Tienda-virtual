...
const CreditPayment = () => {
  ...
  return (
    <>
      ...
      <br />
      <span className="d-block padding-s">Opcion de Pago</span>
      <div
        ref={containerRef}
          ...
          <div className="checkout-checkbox-field" ref={checkboxContainerRef}>
            ...
            >
              <div className="d-flex-grow-1 margin-left-s">
                <h4 className="margin-0">Tarjeta de Credito</h4>
                <span className="text-subtle d-block margin-top-s">
                  Paga con Visa, Master Card y con otras tarjetas de credito y debito
                </span>
              </div>
