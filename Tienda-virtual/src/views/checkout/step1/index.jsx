...
const OrderSummary = ({ basket, subtotal }) => {
  useDocumentTitle('Check Out Paso 1 | Tienda Burgos');
  useScrollTop();
  ...
  return (
    <div className="checkout">
      ...
      <div className="checkout-step-1">
        <h3 className="text-center">Resumen de Orden</h3>
        <span className="d-block text-center">Revisar Productos en la Cesta.</span>
        <br />
