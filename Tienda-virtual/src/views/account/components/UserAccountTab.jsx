      ...
      <div className="user-profile-block">
        ...
        <div className="user-profile-details">
          ...
          {profile.address ? (
            ...
            <h5 className="text-subtle text-italic">Direccion no establecida</h5>
          )}
          ...
          {profile.mobile ? (
            ...
            <h5 className="text-subtle text-italic">Numero de telefono no establecido</h5>
          )}
          <span>Fecha en la que te uniste</span>
          <br />
          {profile.dateJoined ? (
            <h5>{displayDate(profile.dateJoined)}</h5>
          ) : (
            <h5 className="text-subtle text-italic">No disponible</h5>
          )}
        </div>
      </div>
    </div>
