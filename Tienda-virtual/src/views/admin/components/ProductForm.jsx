...
const brandOptions = [
  ...
  { value: 'Herdez', label: 'Herdez' },
  { value: 'Café Madrid', label: 'Café Madrid' },
  { value: 'Frescolita', label: 'Frescolita' },
  ...
  { value: 'Hipermercado Central Madeirense', label: 'Hipermercado Central Madeirense' },
  { value: 'Traki', label: 'Traki' },
  { value: 'Exito', label: 'Exito' },
  { value: 'La Casa de las Carpas', label: 'La Casa de las Carpas' },
        ...
        {({ values, setValues }) => (
          <Form className="product-form">
            <div className="product-form-inputs">
              ...
              <div className="product-form-field">
                <span className="d-block padding-s">Coleccion de Imagenes</span>
                {!isFileLoading && (
              ...
              <div className="product-form-field product-form-submit">
                ...
                >
                  ...
                  &nbsp;
                  {isLoading ? 'Saving Product' : 'Guardar Producto'}
                </button>
              </div>
            </div>
            <div className="product-form-file">
              <div className="product-form-field">
                <span className="d-block padding-s">* Foto de Portada</span>
                {!isFileLoading && (
